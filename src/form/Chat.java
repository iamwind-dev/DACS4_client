    ...
    private void init(){
        ...
        PublicEvent.getInstance().addEventChat(new EventChat() {
            ...
            public void receiveMessage(Model_Receive_Message data, File file) {
                System.out.println("a "+data.getDataImage().getFileName()+" "+data.getDataImage().getImage());
            ...
            public void receiveMessage(Model_MessageDB data) {
                if(chatTitle.getUser().getUserID() == data.getIdreceiver()){
                  chatBody.addItemRight(data.getContent(),data.getTimestamp());
                 } else {
                    chatBody.addItemLeft(data.getContent(),data.getTimestamp(), user);
                }
            }
