...
//     addItemRight("","myFile.rar","20 MB");
    ...
    revalidate();
      ...
      public void addItemLeft(String content,String timestamp, Model_User_Account user){
    ...
    revalidate();
      ...
      public void addItemRight(String content,String timestamp){
...
//    item.setFile(fileName, fileSize);
    ...
    private void initComponents() {
        ...
        body.setBackground(new java.awt.Color(22, 25, 29));
