...
onLoginSuccess();
   ...
   private void onLoginSuccess() {
    login.setVisible(false);  // Ẩn giao diện đăng nhập
    home2.setVisible(true);   // Hiển thị giao diện chat
    Service.getInstance().getClient().emit("list_user", Service.getInstance().getUser().getUserID()); // Lấy danh sách người dùng
    initEvent();  // Khởi tạo các sự kiện còn lại nếu cần
}
